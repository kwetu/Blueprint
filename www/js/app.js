...
(function(){
  ...
  app.controller('radioController', function($scope, $sce, ngAudio){
    ...
    $scope.radioHost = 'http://91.121.165.88:8116/stream'; // Replace this with your own radio stream URL
    ...
    $.SHOUTcast({
       host : '91.121.165.88:8116/stream', // Replace this with your own radio stream URL but remove the http
